            ...
            <div className="container container-lg">
                <div className="breadcrumb-wrapper flex-between flex-wrap gap-16">
                    ...
                    <ul className="flex-align gap-8 flex-wrap">
                        ...
                        <li className="text-sm">
                            <Link to={`/shop/${details?.[0].catName}/${details?.[0].subCatName}/${details?.[0].sid}`} className="text-main-600 flex-align gap-8">
                                {details?.[0].catName}
                            </Link>
                        </li>
                        <li className="flex-align text-gray-500">
                        ...
                        <li className="text-sm">
                            <Link to={`/shop/${details?.[0].catName}/${details?.[0].subCatName}/${details?.[0].sid}`} className="text-main-600 flex-align gap-8">
                                {details?.[0].subCatName}
                            </Link>
                        </li>
                        <li className="flex-align text-gray-500">
                            <i className="ph ph-caret-right" />
                        </li>
                        <li className="text-sm text-neutral-600">{details?.[0].productname}</li>
